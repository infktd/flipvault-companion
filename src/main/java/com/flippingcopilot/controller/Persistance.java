...
public class Persistance {
    ...
    public static final File FV_DIR = new File(RuneLite.RUNELITE_DIR, "flipvault");
    ...
    public static List<Transaction> loadUnAckedTransactions(String displayName) {
        ...
        File file = new File(FV_DIR, String.format(UN_ACKED_TRANSACTIONS_FILE_TEMPLATE, hashDisplayName(displayName)));
        if (!file.exists()) {
    ...
    public static void storeUnAckedTransactions(List<Transaction> transactions, String displayName) {
        File unackedTransactionsFile = new File(FV_DIR, String.format(UN_ACKED_TRANSACTIONS_FILE_TEMPLATE, hashDisplayName(displayName)));
