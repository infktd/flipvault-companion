...
public class AccountsAggregatePanel extends JPanel {
    ...
    public AccountsAggregatePanel(FlipManager flipsManager,
                                  ...
                                  FlipVaultConfig config, ApiRequestHandler apiRequestHandler, FlipManager flipManager) {
        ...
        sortAndFilter = new AccountsAggregateFilterSort(flipsManager, fvLoginRS,
    ...
    private void showAccountMenu(MouseEvent e, int row) {
        ...
        deleteItem.addActionListener(evt -> {
            ...
            if (result == JOptionPane.YES_OPTION) {
                ...
                Runnable onSuccess = () -> {
                    fvLoginRS.removeAccount(a.getAccountId());
